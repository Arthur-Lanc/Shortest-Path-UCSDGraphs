...
class MapNode implements Comparable<MapNode>
{
	...
	MapNode(GeographicPoint loc)
	{
		...
		predictDistance = Double.POSITIVE_INFINITY;
	}
	...
	public int compareTo(MapNode other) {
		...
		return Double.compare(this.predictDistance, other.predictDistance);
	}
	...
	public void setPredictDistance(double predictDistance) {
